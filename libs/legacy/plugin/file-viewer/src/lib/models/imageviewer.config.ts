...
export const IMAGEVIEWER_CONFIG = new InjectionToken<ImageViewerConfig>(
  'imageviewer.config',
  { providedIn: 'root', factory: () => new ImageViewerConfig() }
);
...
export let IMAGEVIEWER_CONFIG_DEFAULT: ImageViewerConfig = {
  ...
  nextPageButton: createButtonConfig(
    String.fromCharCode(0xe805),
    'Next page',
    0
  ),
  beforePageButton: createButtonConfig(
    String.fromCharCode(0xe905),
    'Previous page',
    1
  ),
  ...
  rotateLeftButton: createButtonConfig(
    String.fromCharCode(0xebf4),
    'Rotate left',
    2
  ),
  rotateRightButton: createButtonConfig(
    String.fromCharCode(0xebf5),
    'Rotate right',
    3
  ),
  resetButton: createButtonConfig(String.fromCharCode(0xe954), 'Reset', 4),
  downloadButton: createButtonConfig(
    String.fromCharCode(0xe9c2),
    'Download',
    4
  ),
};
