...
import { FusionConfigService, UserConsentSandbox } from '@exxat/fusion/core';

@Component({
    selector: 'exxat-agreement',
    templateUrl: './exxat-agreement.component.html'
})
export class ExxatAgreementComponent {
