...
@Component({
  selector: 'exxat-mat-select-search',
  templateUrl: './exxat-mat-select-search.component.html',
  styleUrls: ['./exxat-mat-select-search.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => ExxatMatSelectSearchComponent),
      multi: true,
    },
  ],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ExxatMatSelectSearchComponent
  implements OnInit, OnDestroy, ControlValueAccessor
{
  ...
  ngOnInit() {
    ...
    if (this.matOption) {
      ...
      console.error(
        '<exxat-mat-select-search> must be placed inside a <mat-option> element'
      );
    }
  ...
  private initMultipleHandling() {
    ...
    if (!this.matSelect.ngControl) {
      ...
      if (this.matSelect.multiple) {
        ...
        console.error(
          'the mat-select containing exxat-mat-select-search must have a ngModel or formControl directive when multiple=true'
        );
      }
      return;
    }
