...
import { MatTagColors } from '../mat-color-tags';
...
export class FuseMaterialColorPickerComponent implements ControlValueAccessor {
    ...
    set color(value) {
        ...
        // @ Commented To Remove Second Color Palate
    ...
    updateSelectedColor(): void {
        ...
        this.selectedColor = {
            ...
            bg     : this.selectedPalette === '' ? '' : MatTagColors.getColor(this.selectedPalette)[this.selectedHue],
            fg     : this.selectedPalette === '' ? '' : MatTagColors.getColor(this.selectedPalette).contrast[this.selectedHue]
        };
