...
@Component({
  selector: 'zhealthcare-clock',
  templateUrl: './zhealthcare-clock.component.html',
  styleUrls: ['./zhealthcare-clock.component.scss']
})
export class zhealthcareClockComponent implements OnChanges {
