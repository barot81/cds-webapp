...
@Directive({ selector: '[zhealthcareDrawerAction]' })
export class zhealthcareDrawerActionDirective implements OnInit {
  ...
  @Output() zhealthcareDrawerAction: EventEmitter<any> = new EventEmitter<any>();
  ...
  @HostListener('click', ['$event.target']) onClick() {
    ...
    this.zhealthcareDrawerAction.emit();
