...
function createFetchOptions(headers, withCredentials, abortController) {
  return {
    method: "GET",
    headers: {
      Authorization: window.getUrlParameterByName('Auth'),
      Oucodes: window.getUrlParameterByName('Oucodes'),
      TenantId: window.getUrlParameterByName('TanentId'),
...
class PDFFetchStreamReader {
  constructor(stream) {
    ...
    // TODO(Rahul): not sure if this causes bug
    // this._headers=window.getUrlParameterByName('headers');
