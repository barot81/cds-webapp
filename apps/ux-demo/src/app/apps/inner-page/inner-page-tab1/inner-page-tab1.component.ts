...
@Component({
  selector: 'ryzen-inner-page-tab1',
  templateUrl: './inner-page-tab1.component.html',
  styleUrls: ['./inner-page-tab1.component.scss']
})
export class InnerPageTab1Component implements OnInit {
  ...
  chipList: string[] = ['Option1', 'Option2', 'Option3', 'Option4', 'Option5', 'Option6'];
