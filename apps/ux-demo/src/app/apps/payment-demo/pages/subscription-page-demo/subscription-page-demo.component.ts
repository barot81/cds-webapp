...
export class SubscriptionPageDemoComponent implements OnInit {
  ...
  productList = [
    { title: 'STEPS', price: '$50', description: 'This is STEPS product of zhealthcare.', buttonTitle: 'Add to cart' },
    { title: 'Patient Log', price: '$70', description: 'This is patient log product of zhealthcare.', buttonTitle: 'Add to cart' },
    { title: 'Evaluation', price: '$80', description: 'This is evaluation product of zhealthcare.', buttonTitle: 'Add to cart' }
  ];
