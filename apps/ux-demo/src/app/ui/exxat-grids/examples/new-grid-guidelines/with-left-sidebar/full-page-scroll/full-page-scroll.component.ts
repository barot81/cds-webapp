...
import { FuseSidebarService, GoToColumnComponent } from '@zhealthcare/ux';
...
@Component({
  selector: 'ryzen-full-page-scroll',
  templateUrl: './full-page-scroll.component.html',
})
export class FullPageScrollWithSidebarComponent extends GoToColumnComponent implements OnInit {
  ...
  constructor(public _uXDemoDrawerService: UXDemoDrawerService, public headerService: HeaderService, public renderer: Renderer2, private readonly _FuseSidebarService: FuseSidebarService) {
    super(renderer);
