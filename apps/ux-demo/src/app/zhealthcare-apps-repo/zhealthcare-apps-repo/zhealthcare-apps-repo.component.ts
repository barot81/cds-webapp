...
export class zhealthcareAppsRepoComponent {
  ...
  zhealthcare_apps_repo_list: zhealthcare_apps_repo_item[] = [
    // { icon: 'fa-solid fa-file-lines', title: 'Profile - Admin Print Demo', description: 'Profile - Admin Print Demo', page: '/admin/ux/apps/profile-admin-print-demo' },
    {
    ...
    // { icon: 'fa-solid fa-file-lines', title: 'Data Level Security Demo', description: 'Data Level Security Demo', page: '/admin/ux/apps/data-level-security-demo' },
    {
      icon: 'fa-solid fa-file-lines',
    ...
    // { icon: 'fa-solid fa-file-lines', title: 'Release Notes Demo App', description: ['Release Notes Demo App'], page: '/admin/ux/apps/release-notes-demo-app' },
    {
      icon: 'fa-solid fa-file-lines',
    ...
    //{ icon: 'fa-solid fa-file-lines', title: 'Public website demo', description: ['public website demo'], page: '/admin/ux/apps/public-website-demo' },
    // { icon: 'fa-solid fa-file-lines', title: 'Landing page demo', description: ['Landing page demo'], page: '/admin/ux/apps/landing-page-demo' },
    {
      icon: 'fa-solid fa-file-lines',
    ...
    //{ icon: 'fa-solid fa-file-lines', title: 'PatientLog Demo', description: ['PatientLog App Demo'], page: '/admin/ux/apps/patientlog-demo' },
    //{ icon: 'fa-solid fa-file-lines', title: 'Evaluation Admin Demo', description: ['Admin side evaluation module'], page: '/admin/ux/apps/evaluation-admin-demo' },
    {
      icon: 'fa-solid fa-file-lines',
    ...
    //{ icon: 'fa-solid fa-file-lines', title: 'Slot Demo', description: ['Slot Demo'], page: '/admin/ux/apps/slot-demo/tab1' },
    //{ icon: 'fa-solid fa-file-lines', title: 'Tenant Onboarding Demo', description: ['Tenant Onboarding Demo'], page: '/admin/ux/apps/tenant-onboarding-demo' },
    //{ icon: 'fa-solid fa-file-lines', title: 'Institution List Demo', description: ['Institution List Demo'], page: '/admin/ux/apps/institution-list-demo' },
    {
      icon: 'fa-solid fa-file-lines',
    ...
    //{ icon: 'fa-solid fa-file-lines', title: 'Notification Demo', description: ['Notification Demo'], page: '/admin/ux/apps/notification',isAccessible:false },
    {
      icon: 'fa-solid fa-file-lines',
    ...
    //{ icon: 'fa-solid fa-file-lines', title: 'Inner Page Demo', description: ['Inner Page Demo'], page: '/admin/ux/apps/inner-page-demo' },
    //{ icon: 'fa-solid fa-file-lines', title: 'ESS Wizard Demo', description: ['Ess Wizard Demo'], page: '/admin/ux/apps/ESS-wizard/tab1' },
    {
      icon: 'fa-solid fa-file-lines',
